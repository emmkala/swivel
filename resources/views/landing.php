...
<section class="how-it-works">
    ...
    <div class="line3_bg"></div>
</section>

<!----- How we will help Section ----->
...
<section class="start-today-section">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="white-color">Start swiveling today.</h1>
            </div>
        </div>
        <div class="row pt-3">
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <p>Kingston, ON<br> swivelnetwork@gmail.com<br> 647-203-1343</p>
                <p>Copyright Swivel 2020.</p>
            </div>
            <div class="col-md-6">
                <div class="row">
                    <div class="col-4">
